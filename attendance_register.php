...
$cursos = obtenerCursosDeHoy(DATE('Y-m-d'));
?>
                ...
                <tbody>
                    <?php foreach ($cursos as $curso) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-warning" href="listaAsistenciaCurso.php?idCurso=<?php echo $curso->idCurso ?>">
                                    Asistencia <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
